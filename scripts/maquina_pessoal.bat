...
set "packages=Google.Chrome Deezer.Deezer Notion.Notion WhatsApp.WhatsApp Valve.Steam EpicGames.EpicGamesLauncher OpenJS.NodeJS.LTS Git.Git Microsoft.VisualStudioCode JetBrains.IntelliJIDEA.Community Figma.Figma"
